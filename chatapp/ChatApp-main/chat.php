...
<div style="height: 400px;
  overflow: auto;background-color:skyblue;padding: 15px;">
  <?php
  include( 'DatabaseConnection.php' );
  $db = new DatabaseCon;
  session_start();
  $uid = $_SESSION[ 'uid' ];
		$s="select * from chatm where uid=$uid and did=".$_GET['id']." or did=$uid and uid=".$_GET['id'];
		$rs=$db->selectData($s);
		while($row=mysqli_fetch_array($rs))
		{
		?>
		
		<span class="time-left"><?php echo $row['chat_date']; ?></span><br/>
		 <?php
		
		$s1="select * from chats where chat_id=".$row['chat_id'];
...
<div class="container">
  ...
  <p align="right"><?php echo $row1['msg']; ?></p>
...
<?php } ?>
		...
		<?php } ?></div>
	<form action="chataction.php">
	
			<input type = "hidden" name="did" value="<?php echo $_GET['id']; ?>">
			 <textarea name="msg" class="container" cols="95px" required> </textarea> 
                                        ...
                                        <div class="card max-height-vh-70 h-100 overflow-auto overflow-x-hidden mb-5 mb-lg-0" style="max-height: 70vh;">
                                            <div class="card-body p-2">
                                                ...
                                                <div class="p-2 text-center">
                                                    <a href="javascript:;" class="d-block p-2">
                                                        <img alt="Image" src="https://images.unsplash.com/photo-1529068755536-a5ade0dcb4e8?ixlib=rb-1.2.1&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzV8fHBvcnRyYWl0fGVufDB8MnwwfHw%3D&amp;auto=format&amp;fit=crop&amp;w=800&amp;q=60"  class="avatar avatar-lg shadow mb-0">
                                                    </a>
                                                    <div class="ml-2 mt-0 mb-0 text-center">
                                                        <div class="justify-content-between align-items-center">
                                                            <h3 class="mb-0 mt-1">Andrew Jahana</h3>
                                                            <!-- <p class="mb-0 text-sm text-dark font-weight-normal">Endava</p> -->
                                                            <!-- <a href="" class="text-sm ">View profile</a> -->

                                                            <a href="video.html" class="" style=" color: rgb(46, 45, 45);"><i class="fa fa-camera mt-3" title="video call"></i></a>
                                                            <a href="ad.html" class="" style=" color: rgb(46, 45, 45);"><i class="fa fa-phone mt-3 ml-3" title="video call" target=""></i></a>
